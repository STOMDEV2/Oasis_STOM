...
@WebServlet("/workspace/calcul/removeCalcul")
public class RemoveCalculServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public RemoveCalculServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			...
			if(calcul == null)
			{
				map.put("error", "Calcul not found!");
			...
			DaoFactory.getCalculDao().remove(calcul.getId());
			
			map.put("success", "Calcul successfully removed!");
		}
		catch(Exception e)
		{
			e.printStackTrace();
