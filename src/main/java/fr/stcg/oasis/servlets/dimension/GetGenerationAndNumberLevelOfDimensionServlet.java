...
@WebServlet("/workspace/dimension/getGenerationAndNumberLevelOfDimension")
public class GetGenerationAndNumberLevelOfDimensionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
    
    public GetGenerationAndNumberLevelOfDimensionServlet() {
        super();
    }
...
//			IEssCubeView cubeView = cube.openCubeView("default");
			...
			HashMap<String, ArrayList<Integer>> infos = essbase.getGenerationAndNumberLevelOfDimensionServlet(cube);
