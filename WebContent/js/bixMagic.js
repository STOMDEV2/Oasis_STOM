 ...
 */
 ...
 // réécrire la bibli façon part 

var bixMagicSelection = function (  ) {
	...
	return {
		...
		magicSelection : function( elems, options ) {
	...
	selectHandler : function( el, ev, nodelay ) {
		var self = this;
	...
	unselectAllHandler : function( ev ) {
		this.abortSelection();
